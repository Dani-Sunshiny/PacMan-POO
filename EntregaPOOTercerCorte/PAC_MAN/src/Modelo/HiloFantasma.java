 ...
 //Ejecuta el movimiento del fantasma mientras el hilo permanezca activo.
    ...
    public void run() {
        while (activo) {
            ...
            try {
                // Si quieres que el fantasma sea más lento, 
                // simplemente suma un valor fijo a su velocidad base.
                long esperaAdicional = 1000; // milisegundos extra de pausa
                Thread.sleep(fantasma.getVelocidad() + esperaAdicional);
